...
This project — from its functionality to this very README — was written 99% ENTIRELY via prompting by the GitHub repo owner, using ChatGPT as THE MAIN CONDEWRITER.  
